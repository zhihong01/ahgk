...
class Sangong extends MY_Controller {
    ...
    public function index() {
        ...
        foreach ($struct_list as $struct) {
            ...
            if (preg_match('@^/([a-z]+)-([\w\-]+)/$@', $struct, $matches)) {
				...
				$branch_list = $this->site_branch->findList(null,null,array('parent_id'=>$parent_id, 'status' => true, 'removed' => false),null,null,500,0,array('name','_id'),$arr_sort);
