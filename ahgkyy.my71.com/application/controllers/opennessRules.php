...
class opennessRules extends MY_Controller {
    ...
    protected function rulesList($branch_id, $limit = 10, $offset = 0, $length = 60, $sort_by = 0, $date_format = 0) {
        ...
        $select = array('_id', 'title', 'confirm_date','openness_date');
    ...
    public function index() {
        ...
        $total_row = $this->openness_rules->listCount($current_branch_id,array('status' => True, 'removed' => false));
		//print_r($total_row);
        ...
        $data['openness_type']="信息公开制度";
		$data['openness_rules']="hover";
