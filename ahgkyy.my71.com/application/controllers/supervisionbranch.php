...
class supervisionbranch extends MY_Controller {
    ...
    public function index() {
    	...
    	$data=array();
        $View = new Blitz('template/bmyx.html');
        ...
        foreach ($struct_list as $struct) {
            ...
            if (preg_match('@^/([a-z]+)-([\w\-]+)/$@', $struct, $matches)) {
                ...
                if ($action == 'list') {
                    ...
                    $_id_list = $this->child_channel($channel_id);
       ...
       $data['location'] = '<a href="/">网站首页</a> / <a href="/supervisionbranch/">部门信箱</a> ';
        $View->display($data);
    }
