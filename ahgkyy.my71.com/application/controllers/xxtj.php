...
class xxtj extends MY_Controller {
...
//				}
    ...
    protected function counterSupervision() {
        ...
        if (!empty($supervision_counter)) {
			...
			$this_year_counter['all'] = $supervision_counter['this_year_counter'][0]+$supervision_counter['this_year_counter'][1]+$supervision_counter['this_year_counter'][2]+$supervision_counter['this_year_counter'][3];
        }
    ...
    public function index() {
       ...
       //var_dump($type_id);
		if($type_id == 1){
			$View = new Blitz('template/wztj/hdtj.html');
			
		}elseif($type_id == 2){
			$View = new Blitz('template/wztj/zwtj.html');
		}elseif($type_id == 3){
			$View = new Blitz('template/wztj/xxtj.html');
		}
