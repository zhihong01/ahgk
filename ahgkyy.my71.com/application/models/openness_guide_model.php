...
class openness_guide_model extends MY_Model {

    function __construct() {
        parent::__construct();

        $this->table_name = 'openness_guide';
        $this->class_name = 'openness_guide_model';
    }
    ...
    public function listCount($branch_id = null, $keyword = '', $filter_list = array(), $from_date = null, $to_date = null) {
