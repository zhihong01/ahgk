...
class openness_request_dir_model extends MY_Model {

    function __construct() {
        parent::__construct();

        $this->table_name = 'openness_request_dir';
        $this->class_name = 'openness_request_dir_model';
    ...
    public function findList($keyword, $filter_list = array(), $from_date = null, $to_date = null, $limit = 20, $offset = 0, $select = array(), $arr_sort = null) {
        ...
        if (strlen($keyword) > 1) {
            $this->mongo_db->like('content', $keyword);
        }
