...
class openness_request_r_counter_model extends MY_Model {

    function __construct() {
        parent::__construct();

        $this->table_name = 'openness_request_r_counter';
        $this->class_name = 'openness_request_r_counter_model';
    ...
    public function getBranchData( $access_branchs=null, $access_users=null, $filter_list = null, $from_date = null, $to_date = null) {
        ...
        $my_filter_array["reply_type"] = array( "\$gt" => 0 );;

        if ( ($access_branchs != null) && !(is_array($access_branchs))) {
            $my_filter_array["request_branch"] = $access_branchs;
        } else if (($access_branchs != null) && (is_array($access_branchs)) ) {
            $my_filter_array["request_branch"] = array( "\$in" => $access_branchs );
        }
...
//print_r($my_filter_array);
        $query = array(
            ...
            "out" => "openness_request_r_counter"
